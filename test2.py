...
def main():
    ...
    platforms = [Platform((0, 550), 1600, 50), Platform((300, 400), 200, 20), Platform((600, 300), 150, 20)]
    coins = [Coin((320, 370)), Coin((650, 270)), Coin((900, 520)), Coin((1200, 520))]
    obstacles = [Obstacle((800, 530), 30, 20), Obstacle((1000, 530), 30, 20)]
    gravity = 1
    scroll_x = 0
    game_over = False
    ...
    while True:
        ...
        for platform in platforms:
            platform.position = [platform.position[0] - scroll_x, platform.position[1]]
        for coin in coins:
            coin.position = [coin.position[0] - scroll_x, coin.position[1]]
        for obstacle in obstacles:
            obstacle.position = [obstacle.position[0] - scroll_x, obstacle.position[1]]
